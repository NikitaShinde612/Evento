...
import com.app.razorpayintegration.RazorpayService;
...
public class OrdersServiceImpl implements OrdersService {
	...
	public OrdersDto addOrder(Long userId,CreateOrder createOrder) {
		...
		int amount = subscription.getDiscount()>0?(int) (subscription.getPrice() * subscription.getDiscount()):subscription.getPrice();
		RazorpayService rService = new RazorpayService();
		String transactionId = rService.createPaymentOrderId(amount*100+"");
